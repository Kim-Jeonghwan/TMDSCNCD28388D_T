...
/**
 * @function    static void setupEPWM8_TimeBase(uint16_t prd)
...
static void setupEPWM8_TimeBase(uint16_t prd)
{
    ...
    EPWM_setClockPrescaler(EPWM8_BASE, EPWM_CLOCK_DIVIDER_2, EPWM_HSCLOCK_DIVIDER_1); // 클럭 분주 /2
...
/**
 * @function    static void setupEPWM8_ActionQualifier(void)
...
/**
 * @function    static void setupEPWM8_AdcTrigger(void)
